export default {
  ...
  settings: {
    ...
    freeForever: 'No fees, no subscriptions, yours forever',
    fullTransparency: '100% transparent • Review every line of code',
  ...
  privacy: {
    ...
    compact: 'Your data, your responsibility',
    localOnly: 'All data stays on your device - we have no servers',
    yourKeys: 'You manage your own API keys and costs',
    yourResponsibility:
      'You are responsible for compliance with API terms and data protection laws',
